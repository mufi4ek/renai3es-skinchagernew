...
export function Inventory() {
  ...
  return (
    <>
      ...
      <div className="m-auto grid w-full select-none [grid-template-columns:repeat(auto-fit,minmax(154px,1fr))] px-2 [grid-gap:1em] lg:my-8 lg:w-[1024px] lg:px-0">
      ...
      {displayedItems.length === 0 && (
        <div className="m-auto flex justify-center select-none lg:w-[1024px]">
          <div className="flex w-full items-center justify-center gap-2 bg-linear-to-r from-transparent via-black/30 to-transparent py-1 text-neutral-200">
